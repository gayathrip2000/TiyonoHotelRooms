    ...
    return (
        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <a className="navbar-brand" href="/home">Tiyono Rooms</a>
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav"
                    aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">

                    <span className="navbar-toggler-icon" ><i class="fa-solid fa-bars" style={{ color: 'white' }}></i>
                    </span>
                </button>
                    ...
                    <ul className="navbar-nav mr-2">
                        ...
                        {user ? (
                            <><div className="dropdown">
                                ...
                                <button className="btn btn-secondary dropdown-toggle" type="button" id="doropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
